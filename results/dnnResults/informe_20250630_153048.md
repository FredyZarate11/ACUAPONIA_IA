...
- **Modelo:** `DNN`
- **Fecha de Ejecución:** `2025-06-30 15:30:54`
...
| Métrica | Valor |
|---|---|
| **R² (Coef. de Determinación)** | **0.9802** |
| RMSE (Raíz del Error Cuadrático) | 19.0763 |
| MAE (Error Absoluto Medio) | 11.4834 |
| MSE (Error Cuadrático Medio) | 363.9042 |
| Error Relativo Promedio | 7.62% |
...
![Gráfico de Evaluación](evaluacion_20250630_153048.png)
