...
- **Modelo:** `DNN_Generico`
- **Fecha de Ejecución:** `2025-06-30 16:35:03`
...
| Métrica | Valor |
|---|---|
| **R² (Coef. de Determinación)** | **0.9898** |
| RMSE (Raíz del Error Cuadrático) | 13.7119 |
| MAE (Error Absoluto Medio) | 10.1145 |
| MSE (Error Cuadrático Medio) | 188.0154 |
| Error Relativo Promedio | 6.71% |
...
![Gráfico de Evaluación](evaluacion_20250630_163457.png)
