...
- **Modelo:** `ANN Simple`
- **Fecha de Ejecución:** `2025-06-21 19:05:57`
...
| Métrica | Valor |
|---|---|
| **R² (Coef. de Determinación)** | **0.8503** |
| RMSE (Raíz del Error Cuadrático) | 100.1412 |
| MAE (Error Absoluto Medio) | 44.5920 |
| MSE (Error Cuadrático Medio) | 10028.2507 |
| Error Relativo Promedio | 20.70% |
...
![Gráfico de Evaluación](grafico_20250621_190535.png)
