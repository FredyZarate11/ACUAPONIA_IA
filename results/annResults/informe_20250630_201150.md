...
- **Modelo:** `ANN`
- **Fecha de Ejecución:** `2025-06-30 20:11:55`
...
| Métrica | Valor |
|---|---|
| **R² (Coef. de Determinación)** | **0.9798** |
| RMSE (Raíz del Error Cuadrático) | 19.2457 |
| MAE (Error Absoluto Medio) | 13.1573 |
| MSE (Error Cuadrático Medio) | 370.3954 |
| Error Relativo Promedio | 8.73% |
...
![Gráfico de Evaluación](evaluacion_20250630_201150.png)
